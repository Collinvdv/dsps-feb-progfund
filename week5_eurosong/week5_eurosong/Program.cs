...
class Program
{
    static void Main(string[] args)
    {
        ...
        if (belgiumPoints > spainPoints && belgiumPoints > netherlandsPoints)
        {
            Console.WriteLine("Belgium is the winner");
        } else if (netherlandsPoints > belgiumPoints && netherlandsPoints >+ spainPoints)
        {
            Console.WriteLine("Netherlands is the winner");
        } else
        {
            Console.WriteLine("Spain is the winner");
        }
